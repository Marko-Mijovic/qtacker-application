...
@RestController
@RequestMapping("/api/qtacker-application-kafka")
public class QtackerApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(QtackerApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public QtackerApplicationKafkaResource(KafkaProperties kafkaProperties) {
