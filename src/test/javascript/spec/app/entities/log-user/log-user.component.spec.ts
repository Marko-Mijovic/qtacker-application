...
import { LogUserComponent } from 'app/entities/log-user/log-user.component';
import { LogUserService } from 'app/entities/log-user/log-user.service';
import { LogUser } from 'app/shared/model/log-user.model';

describe('Component Tests', () => {
  describe('LogUser Management Component', () => {
    let comp: LogUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LogUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.logUsers && comp.logUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
