...
import { MakerComponent } from 'app/entities/maker/maker.component';
import { MakerService } from 'app/entities/maker/maker.service';
import { Maker } from 'app/shared/model/maker.model';

describe('Component Tests', () => {
  describe('Maker Management Component', () => {
    let comp: MakerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MakerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.makers && comp.makers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
