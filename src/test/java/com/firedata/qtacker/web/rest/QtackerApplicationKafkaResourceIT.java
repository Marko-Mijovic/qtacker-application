...
import com.firedata.qtacker.config.KafkaProperties;
...
class QtackerApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        QtackerApplicationKafkaResource kafkaResource = new QtackerApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/qtacker-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/qtacker-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
